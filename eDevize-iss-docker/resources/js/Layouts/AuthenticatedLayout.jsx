                            ...
                            <div className="ml-3 relative">
                                <Dropdown>
                                    ...
                                    <Dropdown.Content>
                                        ...
                                        {user.permissions & 4 ? (<Dropdown.Link href={route('register')}>Register employee</Dropdown.Link>) : null}
                                        {user.permissions & 1 ? (<Dropdown.Link href={route('customers.create')}>Add customer</Dropdown.Link>) : null}
